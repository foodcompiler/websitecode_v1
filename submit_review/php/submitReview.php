...
if(isset($_POST["submit"])){
	...
	$category_internal = $_POST['category'];
	...
	$sql = "INSERT INTO foodtable (dish_id, category_internal, location, restaurant, type, dish_name, price, rating, is_validated) VALUES ('', '$category_internal', '$location', '$restaurant', '$type', '$dish_name', '$price', '$rating', 0)";
